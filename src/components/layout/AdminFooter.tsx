...
export const AdminFooter: React.FC = () => {
  ...
  return (
    <footer className="w-full py-2.5 px-4 sm:px-6 pb-[calc(0.625rem+72px)] lg:pb-2.5 flex flex-col sm:flex-row justify-between items-center text-[11px] text-[#44483e] mt-auto border-t border-[#c4c8bb]/20 bg-[#FFF8F4]">
