            ...
            <div className="bg-gradient-to-br from-[#2C4219] via-[#243816] to-[#1a2c0f] text-white rounded-3xl px-6 sm:px-8 lg:px-10 py-8 sm:py-10 relative overflow-hidden shadow-2xl border border-[#C3E28D]/15 flex-1 flex flex-col justify-center min-h-[340px]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center relative z-10">
                ...
                <div className="lg:col-span-7 space-y-5 text-left">
                  ...
                  {/* Feature chips — dekorasi visual dari fitur utama */}
                  <div className="flex flex-wrap gap-2 pt-1">
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/[0.06] border border-white/10 text-[10px] font-semibold text-[#d4e8b8]/90">
                      <Sprout className="w-3 h-3 text-[#C3E28D]" />
                      Monitoring Panen
                    </span>
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/[0.06] border border-white/10 text-[10px] font-semibold text-[#d4e8b8]/90">
                      <ShieldCheck className="w-3 h-3 text-[#C3E28D]" />
                      Sertifikat Halal & P-IRT
                    </span>
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/[0.06] border border-white/10 text-[10px] font-semibold text-[#d4e8b8]/90">
                      <Truck className="w-3 h-3 text-[#C3E28D]" />
                      Peralatan Pertanian
                    </span>
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/[0.06] border border-white/10 text-[10px] font-semibold text-[#d4e8b8]/90">
                      <TrendingUp className="w-3 h-3 text-[#C3E28D]" />
                      Logistik Keuangan
                    </span>
                  </div>
                </div>
